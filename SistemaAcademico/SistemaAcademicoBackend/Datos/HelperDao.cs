...
namespace SistemaAcademicoBackend.Datos
{
    public class HelperDao
    {
        ...
        public HelperDao()
        {
            conexion = new SqlConnection(@"Data Source=HERRADO\SQLEXPRESS;Initial Catalog=Sistema_Academico2;Integrated Security=True");
        }
